<template>
  <div class="page-shell">
    <section class="page-hero" aria-label="Life and Learning overview">
      <div class="page-hero__grid">
        <div class="page-hero__copy">
          <nav class="page-breadcrumb" aria-label="Breadcrumb">
            ...
            <span class="page-breadcrumb__current">Life and Learning</span>
          </nav>
...
const THEME_ROUTE = '/themes/life-and-learning';
