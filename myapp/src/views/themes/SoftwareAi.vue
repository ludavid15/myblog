<template>
  <div class="page-shell">
    <section class="page-hero" aria-label="Software and AI overview">
      <div class="page-hero__grid">
        <div class="page-hero__copy">
          <nav class="page-breadcrumb" aria-label="Breadcrumb">
            ...
            <span class="page-breadcrumb__current">Software and AI</span>
          </nav>
...
const THEME_ROUTE = '/themes/software-and-ai';
