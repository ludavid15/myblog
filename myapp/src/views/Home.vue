    ...
    <v-row justify="center">
      <v-col cols="10" >
        ...
        <p class="text-h6 mb-4">
          ...
          handy reference in case I need to go back and review something. Maybe some of it will 
          be useful for you!
        </p>
        <p class="text-h6 mb-8">
          What you're reading is version two of my website. It replaces the old site that was
          built using a Jekyll theme and hosted on Github. This new website is built from scratch 
          using Vue and hosted on AWS in an S3 bucket. Development and deployment are managed 
          locally using a Docker container. I use Route53 and CloudFront to serve this website to 
          the internet. 
        </p>
